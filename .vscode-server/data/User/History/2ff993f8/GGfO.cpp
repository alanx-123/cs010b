...
int main(){
    ...
    SortedSet set3 = set1;
    cout << "Testing copy constructor for SortedSet " << endl;
    cout << set3 << endl;
    ...
    cout << "Testing add function. (note: if add function works, then push_back, push_front, etc. all work by default. " << endl;
    cout << set2 << endl;

...
int main()
{
    ...
    printVector(testVector);
    cout << endl;
    if (testVector.at(4) != 6 || testVector.size() != 5){
    ...
    printVector(testVector);
    cout << endl;
    cout << "New Capacity: " << testVector.capacity() << endl;
    ...
    testVector.clear();
    cout << "Vector after using clear function: ";
    printVector(testVector);
    ...
    IntVector newVector(5, 0);

    cout << "Stage 3: " << endl;
    cout << "Test #1, insert function: " << endl;
    newVector.insert(2, 5);
    cout << "Vector after using insert function: " << endl;
    printVector(newVector);
    cout << "New size: " << newVector.size() << endl;
    cout << "New capacity: " << newVector.capacity() << endl;
    if (newVector.at(2) != 5)
    {
        cout << "Test #1 failed, insert function" << endl;
    }

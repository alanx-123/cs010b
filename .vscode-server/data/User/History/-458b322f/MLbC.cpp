...
const Rational::Rational(int num)
{
   numerator = num;
   denominator = 1;
}
const Rational::Rational(int numerator, int denominator)
{
...
const Rational Rational::subtract(const Rational &num) 
{
   Rational difference;
...
const Rational Rational::multiply(const Rational &num) 
{
   Rational product;
...
const Rational Rational::divide(const Rational &num) 
{
   Rational quotient;

...
int main()
{
    ...
    ItemToPurchase addingItem("Idiot Sandwich", 3 , 5, "Gordon Ramsay is a world famous chef");
    ItemToPurchase addingItem2("Apple", 3 , 5 , "I love apples");
    ItemToPurchase addingItem3(""Idiot Sandwich", 3 , 5, "Gordon Ramsay is a world famous chef");"


    testCart.addItem(ItemToPurchase);

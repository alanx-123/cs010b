...
int main(int argc, char *argv[])
{
    ...
    inputFlightPathAngle(angle, flightPaths, coeffLifts);
...
void inputFlightPathAngle(double angle, const vector<double> & flightPaths, const vector<double> &coeffLifts){ //for the sake of making main cleaner
